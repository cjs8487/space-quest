...
public class Instance {
    ...
    public Instance(boolean validate) {
        ...
        try (var stack = MemoryStack.stackPush()) {
            ...
            var appInfo = VkApplicationInfo.calloc(stack).sType$Default().pApplicationName(appName)
                    .applicationVersion(1).pEngineName(appName).engineVersion(0).apiVersion(VK_API_VERSION_1_3);
