...
public class ShaderCompiler {
    ...
    public static byte[] compileShader(String shaderCode, int shaderType) {
        ...
        try {
            ...
            if (EngineConfig.getInstance().isDebugShaders()) {
            ...
            long result = Shaderc.shaderc_compile_into_spv(compiler, shaderCode, shaderType, "shader.glsl", "main",
                    options);
    ...
    public static void compileShaderIfChanged(String glsShaderFile, int shaderType) {
        ...
        try {
            ...
            if (!spvFile.exists() || glslFile.lastModified() > spvFile.lastModified()) {
                ...
                Logger.debug("Shader [{}] already compiled. Loading compiled version: [{}]", glslFile.getPath(),
                        spvFile.getPath());
            }
